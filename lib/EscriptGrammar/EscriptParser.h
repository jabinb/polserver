...
public:
  ...
  enum {
    ...
    RuleModuleFunctionDeclaration = 3, RuleUnitExpression = 4, RuleTopLevelDeclaration = 5, 
    RuleFunctionDeclaration = 6, RuleStringIdentifier = 7, RuleUseDeclaration = 8, 
    RuleIncludeDeclaration = 9, RuleProgramDeclaration = 10, RuleStatement = 11, 
    RuleIfStatement = 12, RuleGotoStatement = 13, RuleReturnStatement = 14, 
    RuleConstStatement = 15, RuleVarStatement = 16, RuleDoStatement = 17, 
    RuleWhileStatement = 18, RuleExitStatement = 19, RuleDeclareStatement = 20, 
    RuleBreakStatement = 21, RuleContinueStatement = 22, RuleForStatement = 23, 
    RuleForeachStatement = 24, RuleRepeatStatement = 25, RuleCaseStatement = 26, 
    RuleEnumStatement = 27, RuleBlock = 28, RuleVariableDeclarationInitializer = 29, 
    RuleEnumList = 30, RuleEnumListEntry = 31, RuleSwitchBlockStatementGroup = 32, 
    RuleSwitchLabel = 33, RuleForGroup = 34, RuleBasicForStatement = 35, 
    RuleCstyleForStatement = 36, RuleIdentifierList = 37, RuleVariableDeclarationList = 38, 
    RuleVariableDeclaration = 39, RuleProgramParameters = 40, RuleProgramParameterList = 41, 
    RuleProgramParameter = 42, RuleFunctionParameters = 43, RuleFunctionParameterList = 44, 
    RuleFunctionParameter = 45, RuleScopedMethodCall = 46, RuleExpression = 47, 
    RulePrimary = 48, RuleParExpression = 49, RuleExpressionList = 50, RuleMethodCall = 51, 
    RuleStructInitializerExpression = 52, RuleStructInitializerExpressionList = 53, 
    RuleStructInitializer = 54, RuleDictInitializerExpression = 55, RuleDictInitializerExpressionList = 56, 
    RuleDictInitializer = 57, RuleArrayInitializer = 58, RuleLiteral = 59, 
    RuleIntegerLiteral = 60, RuleFloatLiteral = 61
  };
  ...
  public:
    ...
    antlr4::tree::TerminalNode *LBRACE();
    antlr4::tree::TerminalNode *RBRACE();
    std::vector<StructInitializerExpressionListContext *> structInitializerExpressionList();
    StructInitializerExpressionListContext* structInitializerExpressionList(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *LBRACE();
    antlr4::tree::TerminalNode *RBRACE();
    std::vector<DictInitializerExpressionListContext *> dictInitializerExpressionList();
    DictInitializerExpressionListContext* dictInitializerExpressionList(size_t i);
