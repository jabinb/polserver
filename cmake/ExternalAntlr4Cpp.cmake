...
if(ANTLR4_ZIP_REPOSITORY)
  ExternalProject_Add(
      ...
      CMAKE_CACHE_ARGS
          ...
          -DCMAKE_USER_MAKE_RULES_OVERRIDE:STRING=${CMAKE_CURRENT_LIST_DIR}/c_flag_overrides.cmake
          -DCMAKE_USER_MAKE_RULES_OVERRIDE_CXX:STRING=${CMAKE_CURRENT_LIST_DIR}/cxx_flag_overrides.cmake
      INSTALL_COMMAND ""
      EXCLUDE_FROM_ALL 1)
else()
  ExternalProject_Add(
